...
const detailedCourses = [
  ...
  },
  {
    ...
    "description": "Learn Quran online with Tajweed from certified teachers. Private, one-on-one Quran classes for beginners focused on correct pronunciation, recitation, and Tajweed rules. Book a free trial class today.",
    "icon": "Volume2",
    "image": "/quran-tajweed.jpg",
    "duration": "6-8 Months",
    "suitableFor": "Intermediate",
    "overview": "Learn Quran online with Tajweed from certified teachers. Private, one-on-one Quran classes for beginners focused on correct pronunciation, recitation, and Tajweed rules. Book a free trial class today.",
    "learningOutcomes": [
